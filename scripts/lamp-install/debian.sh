...
################################################################################
### Install required dependencies for Aegir on
#   - Debian 10 (buster)
#   - Debian 9 (stretch)
#
...
#     bash debian.sh -w nginx -p fpm -d mariadb -n aegir.local
#   usage tips:
#     bash debian.sh -h
#
...
# packages being part of the standard Debian image:
#    adduser, ucf, lsb-base, openssl
# packages to be installed on Debian:
